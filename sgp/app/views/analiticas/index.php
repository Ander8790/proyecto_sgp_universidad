...
<div class="dashboard-container slide-up">
    ...
    <!-- ===== BANNER ===== -->
    <div style="background:linear-gradient(135deg,#172554 0%,#1e3a8a 50%,#2563eb 100%);border-radius:24px;padding:40px;margin-bottom:32px;position:relative;overflow:hidden;display:flex;align-items:center;justify-content:space-between;box-shadow: 0 10px 30px rgba(23,37,84,0.15);">
    ...
    <div class="bento-grid">
        ...
        <div class="bento-card b-span-3 accent-green">
            ...
            <span class="kpi-bento-trend trend-up"><i class="ti ti-arrow-up"></i> Sistema</span>
        </div>
        ...
        <div class="bento-card b-span-3 accent-indigo">
            ...
            <span class="kpi-bento-trend trend-up"><i class="ti ti-bolt"></i> Total</span>
        </div>
        ...
        <div class="bento-card b-span-3 accent-amber">
            ...
            <span class="kpi-bento-trend trend-neu"><i class="ti ti-target"></i> Global</span>
        </div>
    ...
    <div class="bento-grid">
        ...
        <div class="bento-card b-span-4">
            ...
            <div class="chart-container-bento" style="min-height:220px;">
    ...
    <div class="bento-grid">
        ...
        <div class="bento-card b-span-5">
            ...
            <div class="chart-container-bento" style="min-height:240px;">
        ...
        <div class="bento-card b-span-7">
            <div class="bento-card-header">
                <div class="bento-card-title">
                    ...
                    Tendencia de Horas Supervision
                </div>
            </div>
            <div class="chart-container-bento">
    ...
    <div class="bento-grid">
        ...
        <div class="bento-card b-span-7">
                ...
                <div class="ranking-item">
                    ...
                    <div class="rank-info">
                        ...
                        <div class="rank-sub">
                            ...
                            <?php if ($eval > 0): ?> · ⭐ <?= number_format($eval, 1) ?><?php endif; ?>
                        </div>
                        <div class="rank-progress-bar">
                            <div class="rank-progress-fill" style="width:<?= min(100,$progreso) ?>%; background:<?= $grad ?>;"></div>
                        </div>
                    </div>
                    <div class="rank-score" style="background:<?= $grad ?>; -webkit-background-clip:text; -webkit-text-fill-color:transparent; font-weight:800;">
            ...
            <?php else: ?>
                <div style="text-align:center;padding:40px;color:#94a3b8;">
                    <i class="ti ti-trophy-off" style="font-size:32px;display:block;margin-bottom:10px;"></i>
        ...
        <div class="bento-card b-span-5">
            ...
            <div class="chart-container-bento" style="min-height:300px;">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (deptData.length > 0) {
        new ApexCharts(document.getElementById('chart-donut-depto'), {
            ...chartOptions,
            chart: { ...chartOptions.chart, type: 'donut', height: 220 },
            series: deptData,
            labels: deptLabels,
            colors: PALETTE,
            dataLabels: { enabled: false },
    ...
    const heatmapSeries = [{
        name: 'Registros',
        data: (Array.isArray(heatmapRaw) ? heatmapRaw : Object.values(heatmapRaw))
                .map((v, i) => ({ x: (i+1).toString(), y: Number(v) || 0 }))
    }];
    new ApexCharts(document.getElementById('chart-heatmap'), {
        ...chartOptions,
        chart: { ...chartOptions.chart, type: 'heatmap', height: '100%', animations: { enabled: false } },
        dataLabels: { enabled: false },
            ...
            heatmap: {
                ...
                colorScale: {
                    ranges: [
                        ...
                        { from: 6,  to: 15, color: '#60a5fa', name: 'Medio'     },
                        { from: 16, to: 100, color: '#2563eb', name: 'Alto'      }
                    ]
                }
            }
        },
    ...
    new ApexCharts(document.getElementById('chart-horas-tendencia'), {
        ...
        series: [{ name: 'Horas', data: <?= $jsHorasMes ?> }],
        colors: ['#6366f1'],
    ...
    const tasaVal    = Number(<?= $kpiTasa ?? 0 ?>);
    const activosVal = Math.min(100, (Number(<?= $kpiActivos ?? 0 ?>) / 50) * 100);
    const progVal    = Number(<?= $kpiProgreso ?? 0 ?>);
    const horasVal   = Math.min(100, (Number(<?= $kpiHoras ?? 0 ?>) / 5000) * 100);

    new ApexCharts(document.getElementById('chart-radar'), {
        ...chartOptions,
        chart: { ...chartOptions.chart, type: 'radar', height: '100%' },
        series: [
            { name: 'Actual', data: [tasaVal, activosVal, progVal, horasVal, 0] },
            { name: 'Meta', data: [100, 100, 100, 100, 100] }
        ],
        colors: ['#2563eb', '#cbd5e1'],
        labels: ['Asistencia', 'Capacidad', 'Progreso', 'Horas', 'Eval.'],
